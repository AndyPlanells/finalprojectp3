...
player::player(string name,string lastname,string username,string password,string email,int VisaCard,int VisaCode,int balance,wow mywow,d3 myd3,sc2 mysc2, Hs myhs)
